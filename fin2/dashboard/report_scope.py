...
RELATIONS = {
    ...
    'asset': [('portfolio.asset','source_record_id'),('market.asset_catalog','source_record_id'),
        ...
        ('market.daily_close','source_record_id'),('market.b3_daily_close','source_record_id'),
        ('market.daily_close_series','source_record_id'),('market.price_observation','source_record_id')],
