...
class DashboardTests(unittest.TestCase):
    ...
    def test_account_detail_and_menu_links(self):
        ...
        self.assertIn('Adicionar aplicação', html)
        self.assertIn('/fin2/cadastros/aplicacao/?', html)
        self.assertIn(f'conta_id={account_id}', html)
        ...
        for tab, heading in [('movimentacoes', 'Extrato do ledger')]:
            ...
            self.assertIn('class="button" href="/fin2/extratos/?', movement_html)
            self.assertIn('>Importar extrato</a>', movement_html)
